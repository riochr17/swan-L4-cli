...
Alternatively, you can download pre-compiled standalone executables for Linux, macOS, and Windows directly from the [v0.0.10-alpha Release Page](https://github.com/riochr17/swan-L4-cli/releases/tag/0.0.10-alpha).
